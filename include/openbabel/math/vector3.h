...
public:
  //! Constructor
  vector3(const double inX = 0.0, const double inY = 0.0,
          const double inZ = 0.0)
      : _vx(inX), _vy(inY), _vz(inZ) {}
  vector3(double inV[3]) : _vx(inV[0]), _vy(inV[1]), _vz(inV[2]) {}
  //! Copy Constructor
  ...
  const double *AsArray() const { return &_vx; }
  ...
  inline double length_2() const { return _vx * _vx + _vy * _vy + _vz * _vz; };
  //! \return The vector length
  double length() const { return sqrt(length_2()); };
  //! Access function to get the x-coordinate of the vector
  const double &x() const { return _vx; };
  //! Access function to get the y-coordinate of the vector
  const double &y() const { return _vy; };
  //! Access function to get the z-coordinate of the vector
  const double &z() const { return _vz; };
  //! Access function to set the x-coordinate of the vector
  double &x() { return _vx; };
  //! Access function to set the y-coordinate of the vector
  double &y() { return _vy; };
...
//! Prints a representation of the vector as a row vector of the form
//! "<0.1,1,2>"
