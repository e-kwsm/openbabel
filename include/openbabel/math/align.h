 ...
 * \brief Perform a least-squares alignment of two molecules or two vectors of
 * vector3 objects
 *
...
public:
   ...
   * Align two molecules.
   */
  OBAlign(const OBMol &refmol, const OBMol &targetmol, bool includeH = false,
          bool symmetry = true);
  /**
...
private:
  ...
  void VectorsToMatrix(const std::vector<vector3> *pcoords,
