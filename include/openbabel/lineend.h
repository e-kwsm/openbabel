...
public:
  FilteringInputStreambuf(std::istream *source = nullptr);
  ...
  virtual std::streampos seekoff(
    ...
    setg(&myBuffer, &myBuffer,
         &myBuffer); // ensure next character is from new position
  ...
  std::istream *GetSource() const { return mySource; };
...
//////////////////////////////////////////////////////////
template <class Extractor> int FilteringInputStreambuf<Extractor>::underflow() {
  int result(EOF);
  if (gptr() < egptr())
    result = *gptr();
...
//////////////////////////////////////////////////////
template <class Extractor> int FilteringInputStreambuf<Extractor>::sync() {
  int result(0);
  if (mySource != nullptr) {
...
/*! \class FilteringInputStream lineend.h <openbabel/lineend.h>
  ...
  */
template <class Extractor>
class FilteringInputStream : virtual private FilteringInputStreambuf<Extractor>,
                             public std::istream {
public:
