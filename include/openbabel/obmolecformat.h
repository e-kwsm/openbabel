...
public:
  OBMoleculeFormat() {
    if (!OptionsRegistered) {
      ...
      OBConversion::RegisterOptionParam("title", this, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("addtotitle", this, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("property", this, 2,
                                        OBConversion::GENOPTIONS);
      ...
      OBConversion::RegisterOptionParam("join", this, 0,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("separate", this, 0,
                                        OBConversion::GENOPTIONS);
      ...
      OBConversion::RegisterOptionParam("s", nullptr, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("v", nullptr, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("h", nullptr, 0,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("d", nullptr, 0,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("b", nullptr, 0,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("c", nullptr, 0,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("p", nullptr, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("t", nullptr, 0,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("k", nullptr, 0,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("filter", nullptr, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("add", nullptr, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("delete", nullptr, 1,
                                        OBConversion::GENOPTIONS);
      OBConversion::RegisterOptionParam("append", nullptr, 1,
                                        OBConversion::GENOPTIONS);
    }
  }
  ...
  /// \name Routines to handle the -C option for combining data from several
  /// OBMols
  //@{
  ...
  static bool OutputMolsFromReaction(OBReaction *pReact, OBConversion *pConv,
                                     OBFormat *pFormat);
  ...
  const std::type_info &GetType() override { return typeid(OBMol *); }
