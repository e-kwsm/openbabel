...
//!
//! Reactants and products stored as smart pointers to molecules stored
//! elsewhere.
//!
...
public:
  ...
  int NumAgents() const { return static_cast<int>(_agents.size()); }
  ...
  static const char *ClassDescription() { return " reactions\n"; }
