...
// Class to store values for generic (non axis aligned) grids like Gaussian cube
// files Class introduction in griddata.cpp
...
public:
  ...
  /// \return vector3 of the origin (i.e., the minimum x, y, and z coords of the
  /// grid).
  vector3 GetOriginVector() const;
  /// \param o set to the origin (i.e., the minimum x, y, and z coords of the
  /// grid). \deprecated Will be removed. \sa GetOriginVector()
