...
namespace OpenBabel {
/** \brief Functions and constants for handling the elements of the periodic
...
cout << "The atomic number for Sulfur is " << OBElements::GetAtomicNum(16) <<
endl; cout << "The van der Waal radius for Nitrogen is " <<
OBElements::GetVdwRad(7); if (atom->GetAtomicNum() == OBElements::Carbon) {
  // then do something
}
\endcode
...
//!         or by default (i.e. "isotope 0") the mass of the most abundant
//!         isotope
