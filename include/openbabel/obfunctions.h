...
Note that alternative algorithms may be more appropriate if you wish to
calculate this value for all atoms in a molecule.
...
OBAPI unsigned int GetTypicalValence(unsigned int element, unsigned int bosum,
                                     int charge);
/**
