...
enum HydrogenType { AllHydrogen, PolarHydrogen, NonPolarHydrogen };
 ...
 class OBAPI OBMol: public OBBase
  ...
  public:
    ...
    // docs in mol.cpp
    bool CopySubstructure(OBMol& newmol, OBBitVec *includeatoms, OBBitVec *excludebonds = nullptr,
      unsigned int correctvalence=1,
      std::vector<unsigned int> *atomorder=nullptr,
      std::vector<unsigned int> *bondorder=nullptr);
