...
public:
  /// Default constructor. Registration via RegisterFormat(), not via
  /// constructor as in other plugins.
  OBFormat() {}
  ...
  /// @brief Information on this format. Printed out in response to -Hxxx option
  /// where xxx id the id of the format.

  /// Must be provided by each format class.
  /// Can include a list of command line Options. These may be used to
  ...
  /// If not provided, the object type used by the default format is used
  /// (usually OBMol).
  ...
  /// if there are member variables and the format is used in more than one
