...
public:
  ...
  //! max (e.g., if you want the square root of 144, supply 12 for max) \param
  //! max The maximum square root stored in the lookup table \param incr The
  //! floating point resolution of the lookup table
  ...
  //! you want the square root of 144, supply 12 for max) \param incr The
  //! floating point resolution of the lookup table
