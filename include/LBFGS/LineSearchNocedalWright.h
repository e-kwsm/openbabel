// Copyright (C) 2016-2019 Yixuan Qiu <yixuan.qiu@cos.name> & Dirk Toewe
// <DirkToewe@GoogleMail.com> Under MIT license
...
public:
  ...
  /// length. \param drt    The current moving direction. \param xp     The
  /// current point. \param param  Parameters for the LBFGS algorithm
  ///
