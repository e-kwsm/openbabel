...
#if (defined(__GNUC__) && defined(__MINGW32__) && __GNUC__ == 3 &&             \
     __GNUC_MINOR__ == 2 && __GNUC_PATCHLEVEL__ == 0 && defined(_WIN32))
/* replace with the proper definition for GNU gcc & MinGW-2.0.0-3 (mingw special
 * 20020817-1), gcc 3.2 core */
