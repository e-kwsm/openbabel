...
/* size resrictions */
#define ATOM_EL_LEN                                                            \
  6 /* length of atom name string including zero termination */
#define ATOM_INFO_LEN                                                          \
  36 /* inf_ATOM output string ^123Al^+2H12..(+)/999/999/999/999: 32 chars */
...
#define NUM_H_ISOTOPES                                                         \
  3             /* number of hydrogen isotopes: protium, deuterium, tritium */
...
#define SALT_DONOR_ALL                                                         \
  (SALT_DONOR_Neg | SALT_DONOR_H | SALT_p_ACCEPTOR | SALT_p_DONOR)
