...
typedef struct tagStructData {
  ...
  INCHI_MODE bTautFlags[INCHI_NUM];     /* reconnected does not have
                                           TG_FLAG_DISCONNECT_COORD_DONE flag */
  INCHI_MODE bTautFlagsDone[INCHI_NUM]; /* reconnected does not have
                                           TG_FLAG_DISCONNECT_COORD_DONE flag */
...
void FillTableParms(SET_DRAW_PARMS *sdp, INChI **cur_INChI,
                    ...
                    int bShowIsotopic, int bShowTaut);
...
int ReadTheStructure(STRUCT_DATA *sd, INPUT_PARMS *ip, INCHI_IOSTREAM *inp_file,
                     ORIG_ATOM_DATA *orig_inp_data, int inp_index,
                     int *out_index);
...
int TreatCreateOneComponentINChIError(STRUCT_DATA *sd, INPUT_PARMS *ip,
                                      ...
                                      long num_inp, INCHI_IOSTREAM *inp_file,
                                      INCHI_IOSTREAM *log_file,
                                      INCHI_IOSTREAM *output_file,
                                      INCHI_IOSTREAM *prb_file, char *pStr,
                                      int nStrLen);
int TreatCreateINChIWarning(STRUCT_DATA *sd, INPUT_PARMS *ip,
                            ORIG_ATOM_DATA *orig_inp_data, long num_inp,
                            INCHI_IOSTREAM *inp_file, INCHI_IOSTREAM *log_file,
                            INCHI_IOSTREAM *output_file,
                            INCHI_IOSTREAM *prb_file, char *pStr, int nStrLen);
