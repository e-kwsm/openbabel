...
XMLPUBFUN void XMLCALL xmlXPathRegisterVariableLookup(
    xmlXPathContextPtr ctxt, xmlXPathVariableLookupFunc f, void *data);
...
XMLPUBFUN xmlXPathFunction XMLCALL xmlXPathFunctionLookupNS(
...
XMLPUBFUN xmlXPathObjectPtr XMLCALL xmlXPathVariableLookupNS(
    xmlXPathContextPtr ctxt, const xmlChar *name, const xmlChar *ns_uri);
...
XMLPUBFUN void XMLCALL xmlXPathNodeSetAddUnique(xmlNodeSetPtr cur,
                                                xmlNodePtr val);
XMLPUBFUN void XMLCALL xmlXPathNodeSetAddNs(xmlNodeSetPtr cur, xmlNodePtr node,
                                            xmlNsPtr ns);
...
XMLPUBFUN int XMLCALL xmlXPathEvaluatePredicateResult(
    xmlXPathParserContextPtr ctxt, xmlXPathObjectPtr res);
