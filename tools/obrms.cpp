...
int main(int argc, char **argv) {
  ...
  const char *helpmsg =
      ...
      "\t -x, --cross      compute all n^2 RMSDs between molecules of "
      "reference file\n"
      "\t -s, --separate   separate reference file into constituent molecules "
      "and report best RMSD\n"
      "\t -t, --timeout   give up on matching after specified number of "
      "seconds\n"
      "\t -h, --help       help message\n";
