...
load <filename>      load a molecule from filename
done save <filename>      save currently loaded molecule to filename
done ff <forcefield>      select the force field forcefields          print the
available forcefields

energy               calculate the energy done ebond                calculate
the bond stretching energy			" eangle               calculate
the angle bending energy				" estrbnd calculate the
stretch-bending enregy			" eoop                 calculate the
out-of-plane bending energy			" etorsion             calculate
the torsional energy				" evdw                 calculate
the Van der Waals energy				" eeq calculate the
electrostatic energy				"

sd <n>               steepest descent energy minimization for n steps
cg <n>               conjugate gradients energy minimization for n steps

addH                 add hydrogens done delH                 delete hydrogens
done

gen                  generate/minimize a (random) structure
rs                   rotate around all rotatable bonds
todo nconf                print the number of conformers
todo conf <n>             select conformer n
todo
...
int main(int argc, char **argv) {
  ...
  while (1) {
    ...
    if (EQn(commandline, "help", 4) || cin.eof()) {
      ...
      cout << "save <filename>      save currently loaded molecule to filename"
           << endl;
      ...
      cout << "ebond                calculate the bond stretching energy"
           << endl;
      cout << "eangle               calculate the angle bending energy" << endl;
      cout << "estrbnd              calculate the stretch-bending enregy"
           << endl;
      cout << "eoop                 calculate the out-of-plane bending energy"
           << endl;
      ...
      cout << "grad                 calculate the gradients at this point"
           << endl;
      cout << endl;
      cout << "sd <n>               steepest descent energy minimization for n "
              "steps"
           << endl;
      cout << "cg <n>               conjugate gradients energy minimization "
              "for n steps"
           << endl;
      cout << "" << endl;
      ...
      cout << endl;
      cout << "gen                  generate/minimize a (random) structure"
           << endl;
    ...
    if (EQn(commandline, "energy", 6)) {
      ...
      cout << endl
           << "  total energy = " << pFF->Energy() << " " << pFF->GetUnit()
           << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "ebond", 5)) {
      ...
      cout << endl
           << "  bond stretching energy = " << pFF->E_Bond() << " "
           << pFF->GetUnit() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "eangle", 6)) {
      ...
      cout << endl
           << "  angle bending energy = " << pFF->E_Angle() << " "
           << pFF->GetUnit() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "estrbnd", 7)) {
      ...
      cout << endl
           << "  stretch-bending energy = " << pFF->E_StrBnd() << " "
           << pFF->GetUnit() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "eoop", 4)) {
      ...
      cout << endl
           << "  out-of-plane bending energy = " << pFF->E_OOP() << " "
           << pFF->GetUnit() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "etorsion", 8)) {
      ...
      cout << endl
           << "  torsional energy = " << pFF->E_Torsion() << " "
           << pFF->GetUnit() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "evdw", 4)) {
      ...
      cout << endl
           << "  Van der Waals energy = " << pFF->E_VDW() << " "
           << pFF->GetUnit() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "eeq", 3)) {
      ...
      cout << endl
           << "  electrostatic energy = " << pFF->E_Electrostatic() << " "
           << pFF->GetUnit() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "addH", 4)) {
      ...
      if (!pFF->Setup(mol)) {
        cout << "error while initializing the force field for this molecule."
             << endl;
        continue;
      }
      continue;
    ...
    if (EQn(commandline, "nconf", 5)) {
      cout << endl
           << "  number of conformers = " << mol.NumConformers() << endl
           << endl;
      continue;
    }
    ...
    if (EQn(commandline, "ff", 2)) {
      ...
      if (!mol.Empty())
        if (!pFF->Setup(mol))
          cout << "Error while initializing the force field (" << vs[1]
               << ") for this molecule." << endl;
