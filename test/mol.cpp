...
// Define location of file formats for testing
  ...
  // Undefined atomic numbers should be ignored with an obWarning instead of
  // segfault
  ...
  double dihedral =
      CalcTorsionAngle(vector3(-1., -1., 0.), vector3(-1., 0., 0.),
  ...
  if (fabs(dihedral_error) < 0.001) {
    ...
    std::cout << "not ok 15 # CalcTorsionAngle " << dihedral << "!= 180.0"
              << std::endl;
  }
