...
// Define location of file formats for testing
  ...
  while (mifs.peek() != EOF && mifs.good()) {
    ...
    if (counter != mol.NumAtoms())
      cout << "not ok " << ++currentTest << " # atom iterator failed: expected "
    ...
    if (counter != mol.NumAtoms())
      cout << "not ok " << ++currentTest
           << " # depth-first atom iterator failed: expected " << mol.NumAtoms()
           << " but found " << counter << '\n';
    else
      cout << "ok " << ++currentTest << '\n';
    ...
    if (counter != mol.NumBonds())
      cout << "not ok " << ++currentTest << " # bond iterator failed: expected "
           << mol.NumBonds() << " but found " << counter << '\n';
    else
      cout << "ok " << ++currentTest << '\n';
