...
class TestSmartsSym(BaseTest):
    ...
    def testTetStereo(self):
        ...
        self.assertEqual(
            fastcheckmatch(data[0], data[0:6]), [True, False, False, True, False, False]
        )
        self.assertEqual(
            fastcheckmatch(data[2], data[0:6]), [False, True, True, False, False, False]
        )
    ...
    def testRingClosures(self):
        ...
        self.assertEqual(
            fastcheckmatch(data[0], data[0:6]), [True, False, False, True, True, False]
        )
        self.assertEqual(
            fastcheckmatch(data[2], data[0:6]), [False, True, True, False, False, False]
        )
