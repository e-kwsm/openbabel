...
class TestSmartsSym(BaseTest):
    ...
    def testTetStereo(self):
        data = [
            '[C@@](F)(Br)(Cl)I', '[C@](F)(Br)(Cl)I', 'F[C@](Br)(Cl)I',
            'F[C@@](Br)(Cl)I', 'C(F)(Br)(Cl)I', 'FC(Br)(Cl)I'
        ]
    ...
    def testTetStereoImplicitH(self):
        data = [
            '[C@H](Br)(Cl)I', '[C@@H](Br)(Cl)I', 'Br[C@H](Cl)I',
            'Br[C@@H](Cl)I', 'BrC(Cl)I', 'BrC([H])(Cl)I', 'Br[C@@]([H])(Cl)I'
        ]
    ...
    def testRingClosures(self):
        data = [
            '[C@]1(Br)(Cl)NC1', '[C@@]1(Br)(Cl)NC1', 'Br[C@]1(Cl)NC1',
            'Br[C@@]1(Cl)NC1', 'C1N[C@]1(Cl)Br', 'C1NC1(Cl)Br'
        ]
        self.assertEqual(fastcheckmatch(data[0], data[0:6]),
