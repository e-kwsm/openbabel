...
void testEnumerateTautomers(const std::string &smiles, int numTautomers) {
  ...
  public:
    ...
    void operator()(OBMol *, const std::string &) override { numTautomers++; }
  };
...
void testCanonicalTautomers(const std::string &smiles) {
  ...
  canonicalTautomers.erase(
      std::unique(canonicalTautomers.begin(), canonicalTautomers.end()),
      canonicalTautomers.end());
 ...
 */
void testVerifyCanonicalTautomer(const std::string &smiles,
...
int tautomertest(int argc, char *argv[]) {
  ...
  case 8:
    ...
    testVerifyCanonicalTautomer("C1=CC2=C(C=C1Cl)NC(=O)O2",
  ...
  case 10:
    ...
    testVerifyCanonicalTautomer("C1=CC=C(C=C1)C2C(=O)N=C(O2)N",
  ...
  case 19:
    ...
    testVerifyCanonicalTautomer("C1=C(C=C(NC1=O)O)C(=O)O",
                                "OC(=O)c1cc(O)[nH]c(=O)c1");
    break;
  case 20:
    // guanoxabenz
    testEnumerateTautomers("C1=CC(=C(C(=C1)Cl)C=NN=C(N)NO)Cl", 3);
    testCanonicalTautomers("C1=CC(=C(C(=C1)Cl)C=NN=C(N)NO)Cl");
    testVerifyCanonicalTautomer("C1=CC(=C(C(=C1)Cl)C=NN=C(N)NO)Cl",
                                "ONC(=N)NN=Cc1c(Cl)cccc1Cl");
    break;
  case 21:
    // tenoxicam
    // testEnumerateTautomers("CN1/C(=C(\\NC2=CC=CC=N2)/O)/C(=O)C3=C(S1(=O)=O)C=CS3",
    // 5);
    testEnumerateTautomers("CN1C(=C(NC2=CC=CC=N2)O)C(=O)C3=C(S1(=O)=O)C=CS3",
                           5);
    testCanonicalTautomers(
        "CN1/C(=C(\\NC2=CC=CC=N2)/O)/C(=O)C3=C(S1(=O)=O)C=CS3");
    testVerifyCanonicalTautomer(
        "CN1/C(=C(\\NC2=CC=CC=N2)/O)/C(=O)C3=C(S1(=O)=O)C=CS3",
        "OC(=C1C(=O)c2sccc2S(=O)(=O)N1C)Nc1ccccn1");
    break;
  case 22:
    // mitoguazone
    testEnumerateTautomers("CC(=NN=C(N)N)C=NN=C(N)N", 8);
    testCanonicalTautomers("CC(=NN=C(N)N)C=NN=C(N)N");
    testVerifyCanonicalTautomer("CC(=NN=C(N)N)C=NN=C(N)N",
                                "CC(=CN=NC(=N)N)NNC(=N)N");
    break;
  case 23:
    // leucopterin
    testEnumerateTautomers("C12=C(NC(=O)C(=O)N1)N=C(NC2=O)N", 33);
    testCanonicalTautomers("C12=C(NC(=O)C(=O)N1)N=C(NC2=O)N");
    testVerifyCanonicalTautomer("C12=C(NC(=O)C(=O)N1)N=C(NC2=O)N",
  ...
  case 25:
    ...
    testVerifyCanonicalTautomer("CC1=CC(=O)N(C(=C1)C2CCCCC2)O",
  ...
  case 26:
    ...
    testVerifyCanonicalTautomer("C1(=C(NC(=O)NC1=O)O)N=O",
                                "ON=C1C(=NC(=O)N=C1O)O");
    break;
  case 27:
    // methisazone
    ...
    testVerifyCanonicalTautomer("CN1C2=CC=CC=C2C(=NNC(=S)N)C1=O",
  ...
  case 28:
    ...
    testVerifyCanonicalTautomer("Oc1cccc2c1C(=O)c1c(C2)cccc1O",
                                "O=C1C=CC=C2C1=C(O)c1c(C2)cccc1O");
    break;
  case 29:
    ...
    testVerifyCanonicalTautomer("S=c1[nH]c(c([nH]1)c1ccccc1)c1ccccc1",
                                "Sc1nc(c([nH]1)c1ccccc1)c1ccccc1");
    testVerifyCanonicalTautomer("Sc1[nH]c(c(n1)c1ccccc1)c1ccccc1",
                                "Sc1nc(c([nH]1)c1ccccc1)c1ccccc1");
    testVerifyCanonicalTautomer("S=c1[nH]c(c2ccccc2)c(c2ccccc2)[nH]1",
                                "Sc1nc(c([nH]1)c1ccccc1)c1ccccc1");
    break;
  default:
