...
void test_simpleAlign() {
  ...
  vector3 a(-1, -1, 0), b(1, 1, 0), c(-1, 1, 0), d(1, -1, 0),
      e(sqrt(8.) + 1, 1, 0);
...
void test_RMSD() {
  ...
  vector3 a(-1, -1, 0), b(1, 1, 0), c(-1, 1.1, 0), d(1, -1, 0),
      e(sqrt(8.) + 1, 1, 0);
...
void test_alignMol() {
  ...
  OB_ASSERT(!mol_b.GetAtom(1)->GetVector().IsApprox(mol.GetAtom(1)->GetVector(),
                                                    1.0E-8));
...
void test_alignWithoutHydrogens() {
  ...
  // Assert that rotation has occured
  OB_ASSERT(!clone.GetAtom(1)->GetVector().IsApprox(mol.GetAtom(1)->GetVector(),
                                                    1.0E-8));
...
void test_alignWithSymWithoutHydrogens() {
  ...
  clone.SetTorsion(clone.GetAtom(1), clone.GetAtom(2), clone.GetAtom(3),
                   clone.GetAtom(4), (ang + 120) * DEG_TO_RAD);
