...
int shuffletest(int argc, char *argv[]) {
  ...
  case 1:
    ...
    OB_ASSERT(
        doShuffleTest("N=C\\1/C=C/C(=C(\\c2ccc(N)cc2)/c2ccc(N)c(C)c2)/C=C1"));
    OB_ASSERT(doShuffleTest("N=C\\1/C=C/C(=N\\Cc2ccc(N)cc2)/C=C1"));

    OB_ASSERT(doShuffleTest("[O+]#C[Fe+]1234(C#[O+])(/C=C/CCC/C=C/"
                            "[Fe+]5678(C#[O+])(C#[O+])[C@H]9C7=C6C5=C89)[C@H]"
                            "5C3=C2C1=C45.F[B-](F)(F)F"));
    OB_ASSERT(doShuffleTest("[O+]#C[Fe+]1234(C#[O+])(/C=C/CCCC/C=C/"
                            "[Fe+]5678(C#[O+])(C#[O+])C9=C6C7=C5[C@@H]89)C5="
                            "C3C2=C1[C@H]45.F[B-](F)(F)F"));
    ...
    OB_ASSERT(doShuffleTestOnMultiFile(
        "stereo/error2.smi")); // FYI, kekulization error somewhere in here
  ...
  case 2:
    // OB_ASSERT(
    // doShuffleTest("C12=C3C4=C5[C@@H]1[Fe]16782345C2=C7[C@@]8(C6=C12)[Ge]([C@]12C3=C4C5=C1[Fe]16782345C2=C7C6=C1[C@H]82)([C@@]12C3=C4C5=C1[Fe]16782345C2=C7C6=C1[C@H]82)[C@]12C3=C4C5=C1[Fe]16782345C2=C7C6=C1[C@H]82")
    // );
    OB_ASSERT(doShuffleTest("Br.CC(=O)Nc1ccc(cc1)S(=O)(=O)c1ccc(cc1)NC(=O)"
                            "c1ccccc1SC(=O)CCCCn1ccccc1"));
    OB_ASSERT(doShuffleTest("Br.CC(=O)Nc1cccc(c1)S(=O)(=O)c1cccc(NC(=O)"
                            "c2ccccc2SC(=O)CCCCn2ccccc2)c1"));
    ...
    OB_ASSERT(doShuffleTest(
        "Br.NCCCNCCCCNCCCC[C@@-]12C3=C4C5=C1[Fe+2]16782345[C-]2C7=C6C1=C82"));
    OB_ASSERT(doShuffleTest("Br.NCCCNCCCCNCCCNCCCC[C@-]12C3=C4C5=C1[Fe+2]"
                            "16782345[C-]2C7=C6C1=C82"));
    OB_ASSERT(doShuffleTest("Br.NCCCNCCCCNCCCNCCCC[C@@-]12C3=C4C5=C1[Fe+2]"
                            "16782345[C-]2C7=C6C1=C82"));
    OB_ASSERT(doShuffleTest(
    ...
    OB_ASSERT(doShuffleTest(
        "[Fe+2]12345678([C-]9(C1=C7C6=C29)CCCCNCCCCN)C1=C4C5=C3[C-]81.Br"));
    OB_ASSERT(doShuffleTest("O[C@H]1CC[C@@H](O)CC1"));
    OB_ASSERT(
        doShuffleTest("c1csc(c1)c1nnc(o1)C12C[C@@H]3C[C@@H](C[C@@H](C3)C2)C1"));
    ...
    OB_ASSERT(
        doShuffleTest("c1ccc2c(c1)[C@H]1[C@@H]3O[C@@H]3[C@@H]2c2ccccc12"));
    OB_ASSERT(doShuffleTest("C(C/N=C\\c1ccccc1)/N=C/c1ccccc1"));
    OB_ASSERT(
        doShuffleTest("O=C(CCCC(=O)N/N=C(/C)\\c1ccccc1)N/N=C(\\C)/c1ccccc1"));
    OB_ASSERT(doShuffleTest("C/C(=N/c1ccccc1)/C(=N/c1ccccc1)/C"));
    OB_ASSERT(
        doShuffleTest("OC[C@H](O)COP1(=O)O[Pt@]2(N[C@H]3CCCC[C@@H]3N2)O1"));
