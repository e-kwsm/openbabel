...
int tetraplanartest(int argc, char *argv[]) {
  ...
  // try U -> Z
  OBCisTransStereo::Config shapeZ =
      OBTetraPlanarStereo::ToConfig(cfg, 2, OBStereo::ShapeZ);
  ...
  // try U -> 4
  OBCisTransStereo::Config shape4 =
      OBTetraPlanarStereo::ToConfig(cfg, 2, OBStereo::Shape4);
  ...
  // try Z -> U
  OBCisTransStereo::Config shapeU =
      OBTetraPlanarStereo::ToConfig(shapeZ, 2, OBStereo::ShapeU);
