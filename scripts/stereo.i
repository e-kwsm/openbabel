...
OpenBabel::OBTetrahedralConfig
GetConfig(OBStereo::Winding winding = OBStereo::Clockwise,
          OBStereo::View view = OBStereo::ViewFrom) {
  OpenBabel::OBTetrahedralStereo::Config cConfig =
      self->GetConfig(winding, view);
...
OpenBabel::OBTetrahedralConfig
GetConfig(unsigned long from_or_towards,
          OBStereo::Winding winding = OBStereo::Clockwise,
          OBStereo::View view = OBStereo::ViewFrom) {
  OpenBabel::OBTetrahedralStereo::Config cConfig =
      self->GetConfig(from_or_towards, winding, view);
...
GetConfig(OBStereo::Shape shape = OBStereo::ShapeU) {
...
OpenBabel::OBCisTransConfig
GetConfig(unsigned long start, OBStereo::Shape shape = OBStereo::ShapeU) {
...
OpenBabel::OBSquarePlanarConfig
GetConfig(OBStereo::Shape shape = OBStereo::ShapeU) {
...
OpenBabel::OBSquarePlanarConfig
GetConfig(unsigned long start, OBStereo::Shape shape = OBStereo::ShapeU) {
  OpenBabel::OBSquarePlanarStereo::Config cConfig =
      self->GetConfig(start, shape);
