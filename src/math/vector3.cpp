...
namespace OpenBabel
{
  ...
  */
  ...
  double Point2PlaneSigned(const vector3& a, const vector3& b, const vector3& c, const vector3& d)
  {
    vector3 v_ba = a-b;
  ...
  double Point2Plane(const vector3& a, const vector3& b, const vector3& c, const vector3& d)
  {
