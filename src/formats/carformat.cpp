...
public:
  ...
  {
    return "Accelrys/MSI Biosym/Insight II CAR format\n"
           "Read Options e.g. -as\n"
  ...
  const char *SpecificationURL() override {
    return "http://www.centrcn.umontreal.ca/accelrys/life/insight2000.1/"
           "formats980/Files980TOC.doc.html";
  } // optional

  const char *GetMIMEType() override { return "chemical/x-msi-car"; }
