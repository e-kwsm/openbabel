...
public:
  ...
  ReactionInChIFormat() { OBConversion::RegisterFormat("rinchi", this); }
...
/////////////////////////////////////////////////////////////////
bool ReactionInChIFormat::ReadMolecule(OBBase * /*pOb*/,
                                       OBConversion * /*pConv*/) {
  return true;
}
...
#define M_AGENTS 2
  ...
  if (hasNonInchi) {
    ofs << "/u"
        << (reactants_first ? nonInchi[M_REACTANTS] : nonInchi[M_PRODUCTS])
        << '-'
