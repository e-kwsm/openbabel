...
public:
  SIESTAFormat() { OBConversion::RegisterFormat("siesta", this); }

  const char *Description() override {
    return "SIESTA format\n"
           "The format used by SIESTA (Spanish Initiative for Electronic "
           "Simulations with Thousands of Atoms).\n\n";
  }

  const char *SpecificationURL() override {
    return "http://departments.icmab.es/leem/siesta/";
  }
