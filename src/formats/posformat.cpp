...
public:
  ...
  POSFormat() { OBConversion::RegisterFormat("pos", this); }

  const char *Description() override // required
  {
    return "POS cartesian coordinates format\n"
           "A generic coordinate format\n"
           "The \"POS\" file format is a modified version of the \"XYZ\" "
           "general format\n\n"
  ...
  const char *SpecificationURL() override {
    return "http://cst-www.nrl.navy.mil/lattice/";
  } // optional
...
bool POSFormat::ReadMolecule(OBBase *pOb, OBConversion *pConv) {
  ...
  if (location != string::npos) {
    ...
    string::size_type nonNumber =
        spaceGroupNumber.find_first_not_of("0123456789");
