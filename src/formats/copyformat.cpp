...
public:
  CopyFormat() { OBConversion::RegisterFormat("copy", this); }

  const char *Description() override // required
  {
    return "Copy raw text\n"
           "A utility format for exactly copying the text of a chemical file "
           "format\n"
           "This format allows you to filter molecules from multimolecule "
           "files\n"
           "without the risk of losing any additional information they "
           "contain,\n"
           "since no format conversion is carried out.\n\n"

           ".. warning::\n\n"
           " Currently not working correctly for files with Windows line "
           "endings.\n\n"

           "Example:\n\n"

           "  Extract only structures that include at least one aromatic "
           "carbon\n"
