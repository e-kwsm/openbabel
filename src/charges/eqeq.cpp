...
namespace OpenBabel
{
  ...
  */
  ...
  double EQEqCharges::GetPeriodicEwaldJij(double J_i, double J_j, vector3 dx, bool isSameAtom, matrix3x3 unitcell, matrix3x3 fourier, double cellVolume, const int numNeighbors[])
  {
    int u, v, w;
