...
/// Determines threshold value of Coulomb interaction beyond which the classical
/// 1/R expression will be used instead of an integral over the Gaussian
/// orbitals This is a pre-screening cutoff.
...
public:
  ...
  const char *Description() override {
    return "Assign QTPIE (charge transfer, polarization and equilibration) "
           "partial charges (Chen and Martinez, 2007)";
  }
...
private:
  ...
  bool solver(Eigen::MatrixXd A, Eigen::VectorXd b, Eigen::VectorXd &x,
              const double NormThreshold = 1.e-6);
