...
public:
  ...
  const char *Description() override {
    return "ForceField Energy Evaluation (not displayed in GUI)\n"
           ...
           " --noh        don't add explicit hydrogens (default = make "
           "explicit)\n"
           " --ff #       select a forcefield (default = MMFF94)\n"
           " The hydrogens are made explicit by default before energy "
           "evaluation.\n"
...
//////////////////////////////////////////////////////////
bool OpEnergy::Do(OBBase *pOb, const char * /*OptionText*/, OpMap *pmap,
                  OBConversion *) {
...
public:
  ...
  const char *Description() override {
    return "ForceField Energy Minimization (not displayed in GUI)\n"
           "Typical usage: obabel infile.xxx -O outfile.yyy --minimize --steps "
           "1500\n"
           " options:         description:\n"
           " --log        output a log of the minimization process(default= no "
           "log)\n"
           ...
           "L-BFGS)\n"
           " --lbfgs      use L-BFGS algorithm (the default; flag is for "
           "explicit selection)\n"
           " --newton     use Newton2Num linesearch (default); ignored for "
           "L-BFGS\n"
#else
...
#endif
           " --ff #       select a forcefield (default = MMFF94)\n"
           " --steps #    specify the maximum number of steps (default = "
           "2500)\n"
           ...
           " --rele #     specify the Electrostatic cut-off distance (default "
           "= 10.0)\n"
           " --freq #     specify the frequency to update the non-bonded pairs "
           "(default = 10)\n"
...
//////////////////////////////////////////////////////////
bool OpMinimize::Do(OBBase *pOb, const char * /*OptionText*/, OpMap *pmap,
                    OBConversion *) {
  OBMol *pmol = dynamic_cast<OBMol *>(pOb);
  if (!pmol)
    return false;
