...
public:
  ...
  const char *Description() override {
    return "Confab, the diverse conformer generator\n"
           "Typical usage: obabel infile.xxx -O outfile.yyy --confab --conf "
           "1000000\n"
           "  options:\n"
           "    --conf #     Max number of conformers to test (default is 1 "
           "million)\n"
           "    --rcutoff #  RMSD cutoff (default 0.5 Angstrom)\n"
           "    --ecutoff #  Energy cutoff (default 50.0 kcal/mol)\n"
           "    --original   Include the input conformation as the first "
           "conformer\n"
...
//////////////////////////////////////////////////////////
bool OpConfab::Do(OBBase *pOb, const char *OptionText, OpMap *pmap,
...
void OpConfab::DisplayConfig(OBConversion *pConv) {
  ...
  cout << "..Write input conformation? "
       << (include_original ? "True" : "False") << endl;
