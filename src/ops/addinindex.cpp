...
public:
  ...
  const char *Description() override {
    return "Append input index to title\n"
           "These are objects before filtering. Use AddOutIndex for objects "
           "after filtering\n";
  }
  ...
  bool Do(OBBase *pOb, const char *, OpMap *,
...
/////////////////////////////////////////////////////////////////
bool OpAddInIndex::Do(OBBase *pOb, const char * /*OptionText*/,
                      OpMap * /*pOptions*/, OBConversion *pConv) {
  int count = pConv->GetCount();
  if (count >=
      0) // add nothing unless Convert interface of OBConversion is being used
  {
    std::stringstream ss;
