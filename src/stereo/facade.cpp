...
OBTetrahedralStereo *
OBStereoFacade::GetTetrahedralStereo(unsigned long atomId) {
...
OBStereoFacade::GetSquarePlanarStereo(unsigned long atomId) {
...
void OBStereoFacade::InitMaps() {
  ...
  std::vector<OBGenericData *> stereoData =
      m_mol->GetAllData(OBGenericDataType::StereoData);
...
template <>
OBTetrahedralStereo *
OBStereoFacade::GetStereo<OBTetrahedralStereo>(unsigned long id) {
  return GetTetrahedralStereo(id);
}

template <>
OBCisTransStereo *
OBStereoFacade::GetStereo<OBCisTransStereo>(unsigned long id) {
