...
bool extract_thermochemistry(OpenBabel::OBMol &mol, bool bVerbose, int *Nsymm,
                             int Nrotbonds, double dBdT, double *temperature,
                             double *DeltaHf0, double *DeltaHfT,
                             double *DeltaGfT, double *DeltaSfT, double *S0T,
                             double *CVT, double *CPT,
      ...
      if (0 != TT) {
        if (0 == T) {
          ...
          *temperature = TT;
          ...
          std::cerr << "Different T in the input file, found " << T
                    << " before and now " << TT
