...
#define OB_VERSION_CHECK(major, minor, patch)                                  \
  ((major << 16) | (minor << 8) | (patch))

/* OB_VERSION is (major << 16) + (minor << 8) + patch */
#define OB_VERSION                                                             \
  OB_VERSION_CHECK(@BABEL_MAJ_VER @, @BABEL_MIN_VER @, @BABEL_PATCH_VER @)
...
// Suppress warning on signed/unsigned comparison with < or > (harmless, but
// maybe should be fixed)
#pragma warning(disable : 4018)
// Suppress warning on forcing int etc. value to bool 'true' or 'false'
// (performance warning)
