...
protected:
  ...
  // This specialization is needed because improper-dihedral have different
  // symmetry as dihedrals
  OBFFParameter *GetParameterOOP(const char *a, const char *b, const char *c,
                                 const char *d,
...
public:
  //! Constructor
  explicit OBForceFieldGaff(const char *ID, bool IsDefault = true)
  ...
  std::string GetUnit() override { return std::string("kJ/mol"); }
