...
namespace OpenBabel {
  ...
  */
  ...
  double OBForceFieldUFF::E_VDW()
  {
    ...
    unsigned int j = 0;
    for (vector<OBFFVDWCalculationUFF>::iterator i = _vdwcalculations.begin(); i != _vdwcalculations.end(); ++i, ++j) {
      // Cut-off check
      if (_cutoff)
  ...
  double OBForceFieldUFF::E_Electrostatic()
  {
    ...
    unsigned int j = 0;
    for (vector<OBFFElectrostaticCalculationUFF>::iterator i = _electrostaticcalculations.begin(); i != _electrostaticcalculations.end(); ++i, ++j) {
      // Cut-off check
      if (_cutoff)
