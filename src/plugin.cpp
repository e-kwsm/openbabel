...
void OBPlugin::LoadAllPlugins() {
  ...
  vector<string> files;
  if (!DLHandler::findFiles(files, DLHandler::getFormatFilePattern(),
                            TargetDir)) {
    obErrorLog.ThrowError(__FUNCTION__,
                          "Unable to find OpenBabel plugins. Try setting the "
                          "BABEL_LIBDIR environment variable.",
                          obError);
    return;
  }
...
bool OBPlugin::ListAsVector(const char *PluginID, const char *param,
                            vector<string> &vlist) {
  PluginMapType::iterator itr;
  bool ret = true;
  ...
  if (PluginID) {
    if (*PluginID != 0 && strcmp(PluginID, "plugins")) {
      ...
      ret =
          false; // asked for a type not available; provide plugin types instead
    }
  }
...
void OBPlugin::List(const char *PluginID, const char *param, ostream *os) {
  ...
  if (!ListAsVector(PluginID, param, vlist))
    *os << PluginID
        << " is not a recognized plugin type. Those with instances of "
...
std::vector<std::string> EnableStaticPlugins() {
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theAcesOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theAcesInputFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theACRFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theADFOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theADFInputFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&t41Format__)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theAlchemyFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theAmberPrepFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theAoforceFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOBAPIInterface)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theBallStickFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theCHEM3D1Format)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theCHEM3D2Format)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theChemDrawBinaryXFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theChemDrawFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theChemKinFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theDlpolyConfigFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theDlpolyHISTORYFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theFastSearchFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theFenskeZmatFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theFHIaimsFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theFingerprintFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theFreeFormFractionalFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGAMESSOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGAMESSInputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGaussianCubeFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGaussianOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGaussianInputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGaussianZMatrixInputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGenBankFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGhemicalFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theGROFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGROMOS96Format)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theJaguarOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theJaguarInputFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theMacroModFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theMolproOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theMolproInputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theMolReportFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theMOPACFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theMOPACCARTFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theMOPACINTFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theMPQCInputFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theNWChemOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theNWChemInputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOpenDXCubeFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&thePCModelFormat)->GetID());
...
#endif
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&thePointCloudFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theQChemOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theQChemInputFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theReportFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theSmiReactFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theTurbomoleFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theUniChemFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theVASPFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theViewMolFormat)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theChemDrawXMLFormat)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theCMLFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theCMLReactFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&thePubChemFormat)->GetID());
...
#ifdef HAVE_REGEX_H
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGAMESSUKInputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theGAMESSUKOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOrcaOutputFormat)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOrcaInputFormat)->GetID());
#endif
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&firstSmartsFilter)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&secondSmartsFilter)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin *>(&theTitleFilter)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&TheFormulaDescriptor)->GetID());
  ...
  // forcefields
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theForceFieldGaff)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theForceFieldGhemical)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theForceFieldMMFF94)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theForceFieldMMFF94s)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theForceFieldUFF)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOpAddNonPolarH)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOpDelNonPolarH)->GetID());
  ...
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOpPartialCharge)->GetID());
  plugin_ids.push_back(
      reinterpret_cast<OBPlugin *>(&theOpReadConformers)->GetID());
